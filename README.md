...
[<img alt="Croodle Type" src="screenshots/0_type.png" width="30%">](screenshots/0_type.png)
[<img alt="Croodle Title and Description" src="screenshots/1_title_desc.png" width="30%">](screenshots/1_title_desc.png)
[<img alt="Croodle Days" src="screenshots/2_days.png" width="30%">](screenshots/2_days.png)
[<img alt="Croodle Times" src="screenshots/3_times.png" width="30%">](screenshots/3_times.png)
[<img alt="Croodle Settings" src="screenshots/4_settings.png" width="30%">](screenshots/4_settings.png)
[<img alt="Croodle Settings" src="screenshots/5_votes.png" width="30%">](screenshots/5_votes.png)
