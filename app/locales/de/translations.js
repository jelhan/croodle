export default {
  ...
  'error.poll.savingFailed': 'Die Umfrage konnte nicht gespeichert werden. Bitte versuche es in einigen Sekunden erneut.',
  ...
  'options': 'Optionen',
  'poll.created-date': 'Erstellt am {{date}}.',
  'poll.expiration-date': 'Verfällt am {{date}}.',
  'poll.expiration-date-warning': 'Diese Umfrage verfällt {{timeToNow}} und wird danach automatisch gelöscht.',
