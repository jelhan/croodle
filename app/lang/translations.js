export default {
  ...
  "de": {
    ...
    "poll.error.newUser.everyOptionIsAnswered": "de: you have to answer every options",
    "poll.evaluation.label": "Auswertung",
    "poll.input.newUserName.placeholder": "de: Enter your name...",
    "poll.modal.timezoneDiffers.title": "de: Which timezone should be used for dates?",
    "poll.modal.timezoneDiffers.body": "de: Your timezone differs to timezone poll got created with. Which timezone should be used for dates?",
    "poll.modal.timezoneDiffers.button.useLocalTimezone": "de: my timezone",
    "poll.modal.timezoneDiffers.button.usePollTimezone": "de: original timezone",
    "poll.save": "speichern",
